...
const playerBios: { 
  ...
  'Antony': {
    ...
    club: 'Real Betis',
    image: require('@/assets/images/antonyy.jpg'),
  ...
  'Fred': {
    ...
    club: 'Fenerbahçe',
    image: require('@/assets/images/fred.webp'),
  ...
  'Lucas Paqueta': {
    ...
    image: require('@/assets/images/paqueta.jpg'),
  ...
  'Raphinha': {
    position: 'Atacante',
    club: 'Barcelona',
    image: require('@/assets/images/Raphinha.jpg'),
  ...
  'Gabriel Jesus': {
    position: 'Atacante',
    club: 'Arsenal',
    image: require('@/assets/images/gabrieljesus.jpg'),
  ...
  'Éder Militão': {
    position: 'Zagueiro',
    club: 'Real Madrid',
    image: require('@/assets/images/militao.jpg'),
